...
const slots=[...document.querySelectorAll('.ad-placement ins.adsbygoogle')];
...
function queue(slot){
 ...
 try{(window.adsbygoogle=window.adsbygoogle||[]).push({})}catch{slot.closest('.ad-placement')?.classList.add('ad-unavailable')}
}
